...
namespace KostenloseKurse.Dienste.Rabatt
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(options =>
            {
                ...
                options.Audience = "ressource_rabatt";
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "KostenloseKurse.Dienste.Rabatt", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "KostenloseKurse.Dienste.Rabatt v1"));
            }
