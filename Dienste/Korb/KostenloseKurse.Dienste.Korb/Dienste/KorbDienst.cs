...
namespace KostenloseKurse.Dienste.Korb.Dienste
{
    public class KorbDienst : IKorbDienst
    {
        ...
        public async Task<Antwort<bool>> Löschen(string benutzerID)
        {
            ...
            return status ? Antwort<bool>.Erfolg(204) : Antwort<bool>.Fehlschlagen("Der Korb wurde nicht gefunden!", 404);
        }
        ...
        public async Task<Antwort<KorbDüo>> RufKorb(string benutzerID)
        {
            ...
            {
                return Antwort<KorbDüo>.Fehlschlagen("Korb wurde nicht gefunden!", 404);
        ...
        public async Task<Antwort<bool>> SpeichernOderAktualisieren(KorbDüo korbDüo)
        {
            ...
            return status ? Antwort<bool>.Erfolg(204) : Antwort<bool>.Fehlschlagen("Der Korb wurde nicht gespeichert oder aktualisiert", 500);
        }
    }
}
